...
export default function Hero() {
  return (
    <section className="min-h-screen pt-40 px-6 md:px-50 pb-16 flex flex-col-reverse md:flex-row items-center justify-between gap-12 bg-gradient-to-br from-white to-slate-100">
      {/* Kiri: Tulisan */}
      <div className="md:w-1/2 w-full text-center md:text-left space-y-6">
        <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 leading-tight">
          Stake & Earn <span className="text-blue-600">with ALD TOKEN</span>
        </h1>
